  ...
  render() {
    return (
      <Grid container>
        ...
        <Grid item xs={2}>
        { this.props.stocks && this.props.stocks.bestMatches ? this.props.stocks.bestMatches.map((match) => {
          return (
        ...
        <Grid item xs={5}>
          <StockDetail onAddToMyStocksClicked={this.addToMyStocksClicked} stock={this.props.activeStock}></StockDetail>
        </Grid>
      </Grid>
    )
  }
